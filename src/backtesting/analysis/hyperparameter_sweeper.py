...
quantile_windows      = [75, 100, 150]                      
entry_quantiles       = [0.85, 0.9, 0.92]                   
min_trade_sizes       = [0.01]                        
threshold_multipliers = [0.3, 0.35, 0.4, 0.45]         
max_hold_bars         = [70, 75, 80, 90]                  
stop_loss_mults       = [2.0, 2.25]               
take_profit_mults     = [4.0, 5.0, 6.0]          
